package com.angular.angulartest.test;

import cn.afterturn.easypoi.entity.ImageEntity;
import com.angular.angulartest.util.freemarker.JfreeUtil;
import com.angular.angulartest.util.freemarker.WordUtil;
...
public class test1 {
    public static void main(String[] args) {
        ...
        WordUtil.exportWord("G:\\模板.docx", "G:/", "生成文件.docx", map);
    }
}
